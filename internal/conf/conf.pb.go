...
type Data_Redis struct {
	...
	PoolSize      int32                  `protobuf:"varint,4,opt,name=poolSize,proto3" json:"poolSize,omitempty"`
...
type Micro_LB struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Addr          string                 `protobuf:"bytes,1,opt,name=addr,proto3" json:"addr,omitempty"`
	DisSvrList    []string               `protobuf:"bytes,2,rep,name=dis_svr_list,json=disSvrList,proto3" json:"dis_svr_list,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Micro_LB) GetDisSvrList() []string {
	if x != nil {
		return x.DisSvrList
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x05micro\x18\x03 \x01(\v2\x11.kratos.api.MicroR\x05micro\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\x8b\x03\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x1a\xe1\x01\n" +
	"\x05Redis\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x12\x1a\n" +
	"\bpassWord\x18\x02 \x01(\tR\bpassWord\x12\x0e\n" +
	"\x02db\x18\x03 \x01(\x05R\x02db\x12\x1a\n" +
	"\bpoolSize\x18\x04 \x01(\x05R\bpoolSize\x12<\n" +
	"\fread_timeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\vreadTimeout\x12>\n" +
	"\rwrite_timeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\x99\x01\n" +
	"\x05Micro\x12$\n" +
	"\x02lb\x18\x01 \x01(\v2\x14.kratos.api.Micro.LBR\x02lb\x12'\n" +
	"\x03rpc\x18\x02 \x01(\v2\x15.kratos.api.Micro.RPCR\x03rpc\x1a:\n" +
	"\x02LB\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x12 \n" +
	"\fdis_svr_list\x18\x02 \x03(\tR\n" +
	"disSvrList\x1a\x05\n" +
	"\x03RPCB\x1cZ\x1agateway/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Micro_LB)(nil),            // 8: kratos.api.Micro.LB
	(*Micro_RPC)(nil),           // 9: kratos.api.Micro.RPC
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Micro.lb:type_name -> kratos.api.Micro.LB
	9,  // 8: kratos.api.Micro.rpc:type_name -> kratos.api.Micro.RPC
